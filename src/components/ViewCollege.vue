...
<div>
<nav-bar />
    <b-table striped hover :items="items" :fields="fields"></b-table>   <div>
        <h1>Collge Details</h1>
    <div>
        <b-table-simple>
            <b-row>
            ...
            <b-row v-for="s in college" v-bind:key="s.id">
                ...
                <b-col>
                    ...
                    <span><b-icon icon="pencil-fill" aria-hidden="true" @click="getCollege(s.id)" v-b-modal.modal-center5></b-icon></span>
                </b-col>
            </b-row>            
        </b-table-simple>
    </div>        
